...
<nav class="navbar fixed-top px-0 shadow-sm bg-white">
    <div class="container-fluid">
        ...
        <p class="navbar-brand cursor-pointer">
            <span class="icon-nav m-0 h5" onclick="MenuBarClickHandler()">
                <img class="nav-logo-sm mx-2"  src="{{asset('assets/images/menu.svg')}}" alt="logo"/>
            </span>
            <a href="{{url('/')}}">
                <img class="nav-logo  mx-2"  src="{{asset('assets/images/ulogo.png')}}" alt="logo"/>
            </a>
        </p>
...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/url-shortener")}}" class="side-bar-item">
        <i class="bi bi-link-45deg"></i>
        <span class="side-bar-item-caption">URL Shortener</span>
    </a>
